...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ __('Tentang') }}</h1>
    ...
    <div class="col-lg-8">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-profile-image mt-4">
                <img src="{{ asset('img/stis.png') }}" class="rounded-circle" alt="user-image" style="width:90px">
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12 mb-1">
                        <div class="text-center">
                            <h5 class="font-weight-bold">SiAlumni Politeknik Statistika STIS</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>Kelompok 4 3SI1</p>
                        <ol>
                            <li>Arumia Mustika Rani</li>
                            <li>Desy Ahyu Fitria</li>
                            <li>Moch. Daffa' Alfaris</li>
                            <li>Muhammad Hanief</li>
                            <li>Muhammad Zaki Ramadhani</li>
                            <li>Rayhan Abyasa</li>
                        </ol>
                        ...
                        <a href="https://github.com/muhammadhanief" target="_blank" class="btn btn-github">
