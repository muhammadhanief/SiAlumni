                            ...
                            <form method="POST" action="{{ route('register') }}" class="user" enctype="multipart/form-data">
                                ...
                                <div class="row p-2 mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="tanggalLahir" placeholder="{{ __('Tanggal Lahir') }}" value="{{ old('tanggalLahir') }}" onfocus="(this.type='date')" onblur="(this.type='text')" required>
                                        </div>
                                ...
                                <div class="row p-2">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group" id="skbps">
                                            ...
                                            <a href="http://stis.ac.id/media/source/1.%20surat%20permohonan%20legalisir.pdf" target=”_blank” class="btn btn-sm btn-primary btn-icon-split mb-2 mx-2" aria-hidden="true">
