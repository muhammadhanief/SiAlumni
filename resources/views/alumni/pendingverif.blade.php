...
<body>
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            ...
            <p class="card-text">Saat ini anda tidak bisa melakukan apapun. Silakan tunggu notifikasi bahwa akun anda
                telah aktif melalui email</p>
            ...
            <br>
            <a href="https://mail.google.com/mail/u/0/#inbox" class="card-link" target="blank">Buka Email</a>
        </div>
    </div>
</body>
